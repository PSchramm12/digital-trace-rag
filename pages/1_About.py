...
precomputed and kept in NumPy, and the ONNX model is bundled with the app, so startup
avoids both a heavy vector DB and a runtime model download while staying within **~512 MB** RAM budgets.
